...
<form id="site-content" class="layout-form" themeId="standard1" method="POST" enctype="multipart/form-data">
	...
	<div class="form-header">
		...
		<div class="custom-control custom-switch">
			<input type="checkbox" class="custom-control-input" id="logoHide" name="logo_show_hide" value="<?php echo $logo_show_hide ?>">
				...
				<div class="user-note-detail position-relative">
					...
					<ul>
						<li>
							...
							Suggested Resolution - should be 1700*1100
						</li>
						<li>
							<i class="fas fa-caret-right mr-1"></i>
							Maximum Size - 1MB</li>
	...
	<div class="personal-profile form-section">
		...
		<div class="custom-control custom-switch switch-section">
			<input type="checkbox" class="custom-control-input" id="personalProfile" name="personal_profile_show_hide" value="<?php echo $personal_profile_show_hide ?>">			
			...
			<div class="user-note">
				...
				<div class="user-note-detail position-relative">
					...
					<ul>
						<li>
							<i class="fas fa-caret-right mr-1"></i>
							Suggested Resolution - should be 900*1600
						</li>
						<li>
							<i class="fas fa-caret-right mr-1"></i>
							Maximum Size - 1MB</li>
		...
		<div class="d-inline-block w-100">
			<div class="skills field_wrapper">
				...
				<div class="err-txt-max" style="display:none">
					You have reached maximum of skills
				</div>
			</div>
			...
			<div class="user-note">
				...
				<div class="user-note-detail position-relative">
					...
					<ul>
						<li>
							<i class="fas fa-caret-right mr-1"></i>
							Suggested Resolution - should be 900*1300
						</li>
						<li>
							<i class="fas fa-caret-right mr-1"></i>
							Maximum Size - 1MB</li>
...
// 					alert('Suggested Resolution should be ' + width + " * " + height);
// 				} else {
